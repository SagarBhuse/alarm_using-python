...
head =Label(root,text="Alarm_Clock___saggyCodes",bg="orange",fg="black",font=('bold',20))
head.pack(fill=X)
...
atime = Label(panel,text="Alarm Time",bg="black",fg="white",font=('comic sans',18))
atime.grid(row=0,column=1,padx=10,pady=5)

hr = Entry(panel,font=('comic sans',20),width=5,bg="gray",fg="white")
hr.grid(row=0,column=2,padx=10,pady=5)

amessage = Label(panel,text="Message",bg="black",fg="white",font=('comic sans',20))
amessage.grid(row=1,column=1,columnspan=2,padx=10,pady=5)

amsg = Entry(panel,font=('comic sans',15),width=25,bg="gray",fg="white")

amsg.grid(row=2,column=1,columnspan=2,padx=10,pady=5)


start = Button(panel,text="Set_Alarm",bg="green",fg="red",font=('comic sans',20),command=th)
